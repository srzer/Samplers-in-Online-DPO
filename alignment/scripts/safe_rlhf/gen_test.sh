...
CUDA_VISIBLE_DEVICES=7 python ./generation/safe_rlhf/get_hf2.py --model_name_or_path ${infer_model} --dataset_name_or_path ${prompt_dir} --output_dir ${output_dir} --K ${K} --temperature 0.0 --local_index 0 --my_world_size ${my_world_size} --eos_ids 2 --max_input_length 128 --max_new_tokens 128 --num_iter ${num_iter}
